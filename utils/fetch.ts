...
export interface ResOptionsInterface<T> {
  data: T
  code: number
  message: string
  success: boolean
...
function handleError<T>(
  response: FetchResponse<ResOptionsInterface<T>> & FetchResponse<ResponseType>
) {
...
export const request = {
  get: <T>(url: string, params?: any) => {
    return fetch<ResOptionsInterface<T>>(url, { method: 'get', params })
  },

  post: <T>(url: string, body?: any) => {
    return fetch<ResOptionsInterface<T>>(url, { method: 'post', body })
  },

  put: <T>(url: string, body?: any) => {
    return fetch<ResOptionsInterface<T>>(url, { method: 'put', body })
  },

  delete: <T>(url: string, body?: any) => {
    return fetch<ResOptionsInterface<T>>(url, { method: 'delete', body })
  }
}
