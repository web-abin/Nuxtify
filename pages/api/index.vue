...
<template>
    <div>
        <div class="flex gap-4 flex-wrap">
            <a-button type="primary" status="success" @click="onFetch">$fetch</a-button>
            <a-button type="primary" status="success" @click="onUsefetch">useFetch</a-button>

            <a-button type="primary" status="success" @click="onMyFetch1">请求封装1</a-button>

            <a-button type="primary" status="success" @click="onMyFetch2">请求封装2</a-button>

            <a-button type="primary" status="success" @click="execute()">刷新</a-button>
        </div>
